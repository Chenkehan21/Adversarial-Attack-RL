...
class HumanoidKicker(Humanoid):
    ...
    def __init__(self, agent_id, xml_path=None):
        ...
        self.TARGET_Y = 3
        self.ball_jnt_id = None
        self.ball_jnt_nqpos = None
    ...
    def after_step(self, action):
        ...
        reward = (rinfo['reward_forward'] - rinfo['reward_ctrl'] - rinfo['reward_contact'] +
                  rinfo['reward_survive'] - rinfo['reward_goal_dist'])
    ...
    def _get_obs(self):
        ...
        obs = np.concatenate([state.flat, relative_xyz.flat, np.asarray(ball_goal_dist).flat, ball_goal_y_dist1.flat,
                              ball_goal_y_dist2.flat])
